      ...
      <section>
        ...
        <div className="space-y-16">
          ...
          <section id="acceptance" className="scroll-mt-24">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-8">
              <p className="text-gray-700 leading-relaxed">
                By accessing or using the PrePost Analytics platform, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing this site. Our technical analytics and ML tools are designed specifically to provide data-driven insights for YouTube creators, and your use constitutes acceptance of our specialized data processing methods and algorithm-based reporting.
              </p>
            </div>
          </section>
          ...
          <section id="property" className="scroll-mt-24">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-8">
              <p className="text-gray-700 leading-relaxed">
                All technical infrastructure, machine learning models, UI/UX designs, and generated analytical report structures are the exclusive property of PrePost Analytics. While you retain ownership of your raw YouTube content data, the derivative insights, trend predictions, and visual representations generated by our platform are protected by copyright and trade secret laws.
              </p>
            </div>
          </section>
